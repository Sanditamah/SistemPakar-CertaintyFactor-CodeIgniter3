            ...
            <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9 alert">
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Edit Data Pakar</h5>
                    </div>
                </div>
                <form action="<?= site_url('pakar/ubah/' . $data->id_pakar); ?>" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <br>
                                <input type="radio" name="level_id" <?php if ($data->level_id == '2') {
                                                                        echo 'checked';
                                                                    }
                                                                    ?> value="2" readonly> Pakar &nbsp;
                                <div id="emailHelp" class="form-text text-danger">
                                    <?= form_error('level_id') ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <a href="<?= site_url('pakar') ?>" class="btn btn-sm btn-danger m-1">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
